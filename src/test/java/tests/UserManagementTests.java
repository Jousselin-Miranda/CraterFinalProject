...
public class UserManagementTests {
	...
	static BrowserUtils utils;//this is from the utils/browser
	...
	utils.waitForAllElementsToBeVisible(loginpage.login_page_fielRequired_Messages);
	if(loginpage.login_page_fielRequired_Messages.size()== 2) {
	...
	// then verify that an error message "These credentials do not match our records."displayed
